...
import { addAddress } from '../utils/user';

const AddAddressPg = ({ closePages, pageChange, setAddAddressObj, addAddressObj }) => {
    ...
    const addAddressFormHandler = async(event) => {
        event.preventDefault(); // Prevent default form submission
        try {
            const responseData = await addAddress(JSON.parse(getCookie("userData")).id, addAddressObj);
    ...
    return (
        <div className="edit-address-comp-container">
            ...
            <form className="edit-address-container-2" onSubmit={addAddressFormHandler}>
                ...
                <div className="address-edit-checkbox">
                    <input type='checkbox' className="setAsDefaultCheck" onChange={(e) => handleSetAddAddressObj(prevState => ({ ...prevState, default: e.target.checked }))}></input>
